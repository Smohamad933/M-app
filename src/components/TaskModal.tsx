        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 space-y-4 text-xs">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="مثال: تحویل پیش‌نویس گزارش پروژه..."
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              placeholder="جزئیات بیشتر، نکات مهم، لینک‌ها و ..."
          ...
          <div className="space-y-2 pt-2 border-t border-slate-100 dark:border-slate-800">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-colors font-bold flex items-center justify-center"
              >
          ...
          <div className="pt-4 flex items-center gap-3">
            <button
              type="button"
              onClick={closeTaskModal}
              className="flex-1 py-3 rounded-2xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
            >
              انصراف
            </button>
            <button
              type="submit"
              className="flex-2 py-3 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold shadow-md shadow-indigo-600/30 transition-all flex items-center justify-center gap-2"
            >
