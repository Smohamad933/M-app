...
## 🔑 مشخصات ورود به پنل مدیر ارشد (Mohusyn)
- **نام کاربری:** `Mohusyn`
- **کلمه عبور:** `Smosh1387`

---

## 🛠️ مراحل راه‌اندازی سریع در IIS:
1. پوشه پروژه را در مسیر روت سایت (مانند `C:\inetpub\wwwroot\taskrooz`) قرار دهید.
2. مجوز نوشتن (Write & Modify) برای گروه کاربری `IIS_IUSRS` روی پوشه پروژه و پوشه `data/` تنظیم کنید.
3. در مرورگر به آدرس `http://localhost/install.php` رفته و دیتابیس خود را متصل و مستقر نمایید.
4. دسترسی مستقیم به صفحات:
   - `dashboard.php`: دیلی پلنر و تقویم شمسی
   - `admin.php`: پنل مانیتورینگ ادمین و خروجی اکسل/CSV
   - `login.php`: صفحه ورود
   - `register.php`: ثبت‌نام کاربران با پروفایل کامل
   - `index.html`: اپلیکیشن کامل React PWA با پومودورو و روم‌های تمرکز تیمی
